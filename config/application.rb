...
BassiVeratti::Application.config.contact_us_cc_recipients = {'default'=>'bassi-other@jirasul.stanford.edu', 'error'=>'bassi-problems@jirasul.stanford.edu','other'=>'bassi-other@jirasul.stanford.edu'} # sets the CC email address for each contact us topic configed above
